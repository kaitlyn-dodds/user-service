...
INSERT INTO user_addresses (id, user_id, address_type, address_line_1, address_line_2, city, state, zip_code, country, created_at, updated_at)
VALUES
    -- Kaitlyn
    ('a88d99e2-45e3-49d0-9b1a-15f86db5b140', '4f6a1f00-4b4c-4b5c-9b1f-18e74e66c5b0', 'Home', '123 Maple St', NULL, 'Denver', 'CO', '80202', 'USA', NOW(), NOW()),
    ('a9f43a5d-3729-49e5-9a58-8a1f147b422a', '4f6a1f00-4b4c-4b5c-9b1f-18e74e66c5b0', 'Business', '45 Industrial Blvd', 'Suite 200', 'Aurora', 'CO', '80012', 'USA', NOW(), NOW()),

    -- Matthew
    ('f32b9f7d-84d3-48b5-a321-3f726905b22e', '23c82f4e-728d-4ffb-b4f0-9ac2c310b1c7', 'Business', '9 Evergreen Ct', NULL, 'Boulder', 'CO', '80301', 'USA', NOW(), NOW()),

    -- Sarah
    ('c8a4b5c0-0b3c-4b54-bd6e-9d94659a8df0', 'be93c23e-27f3-4b8d-b403-1d6cb56bb36f', 'Home', '742 Evergreen Terrace', NULL, 'Fort Collins', 'CO', '80521', 'USA', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
